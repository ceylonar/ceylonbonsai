          ...
          <TableBody>
            {products.map((product) => (
              <TableRow key={product.id}>
                ...
                <TableCell className="hidden lg:table-cell">{product.price}</TableCell>
          ...
          {currentProduct && (
            <form onSubmit={handleFormSubmit} className="grid gap-4 py-4 max-h-[80vh] overflow-y-auto pr-6">
              <div className="grid grid-cols-1 md:grid-cols-4 items-center gap-4">
                ...
                <Input id="name" name="name" value={currentProduct.name || ''} onChange={handleFormChange} className="md:col-span-3" />
              </div>
              <div className="grid grid-cols-1 md:grid-cols-4 items-center gap-4">
                <label htmlFor="category" className="md:text-right">Category</label>
                <Input id="category" name="category" value={currentProduct.category || ''} onChange={handleFormChange} className="md:col-span-3" />
              </div>
              <div className="grid grid-cols-1 md:grid-cols-4 items-center gap-4">
                <label htmlFor="price" className="md:text-right">Price</label>
                <Input id="price" name="price" value={currentProduct.price || ''} onChange={handleFormChange} className="md:col-span-3" />
              </div>
              <div className="grid grid-cols-1 md:grid-cols-4 items-start md:items-center gap-4">
                ...
                <Textarea id="description" name="description" value={currentProduct.description || ''} onChange={handleFormChange} className="md:col-span-3" />
              </div>
              <div className="grid grid-cols-1 md:grid-cols-4 items-center gap-4">
                <label htmlFor="image" className="md:text-right">Image URL</label>
                <Input id="image" name="image" value={currentProduct.image || ''} onChange={handleFormChange} className="md:col-span-3" />
              </div>
              <div className="grid grid-cols-1 md:grid-cols-4 items-center gap-4">
                <label htmlFor="width" className="md:text-right">Width</label>
                <Input id="width" name="width" type="number" value={currentProduct.width || ''} onChange={handleFormChange} className="md:col-span-3" />
              </div>
               <div className="grid grid-cols-1 md:grid-cols-4 items-center gap-4">
                <label htmlFor="height" className="md:text-right">Height</label>
                <Input id="height" name="height" type="number" value={currentProduct.height || ''} onChange={handleFormChange} className="md:col-span-3" />
              </div>
              <div className="grid grid-cols-1 md:grid-cols-4 items-center gap-4">
                <label htmlFor="aiHint" className="md:text-right">AI Hint</label>
                <Input id="aiHint" name="aiHint" value={currentProduct.aiHint || ''} onChange={handleFormChange} className="md:col-span-3" />
              </div>
