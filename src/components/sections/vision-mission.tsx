    ...
    <section id="vision-mission" className="py-24 lg:py-32 bg-background">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-20">
          <h2 className="text-4xl md:text-5xl font-headline text-primary tracking-tight">
            Our Vision & Mission
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          <Card className="shadow-xl border-t-4 border-primary bg-card/50 transform transition-transform duration-300 hover:-translate-y-2">
            <CardHeader className="items-center text-center">
              <div className="p-4 bg-primary/10 rounded-full">
                <Eye className="h-8 w-8 text-primary" />
              </div>
              <CardTitle className="mt-6 font-headline text-3xl text-primary">Our Vision</CardTitle>
            </CardHeader>
          ...
          <Card className="shadow-xl border-t-4 border-primary bg-card/50 transform transition-transform duration-300 hover:-translate-y-2">
            <CardHeader className="items-center text-center">
              ...
              <CardTitle className="mt-6 font-headline text-3xl text-primary">Our Mission</CardTitle>
            </CardHeader>
            <CardContent className="text-center">
              <p className="text-muted-foreground text-base leading-relaxed px-4">
